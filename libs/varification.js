...
export const sendInviteAccout = (sender, email, business, url) => {
    const options = {
        from: sender,
        to: email,
        subject: `Invitation to join ${business} on CashBook App`,
        html: `<div style="
        box-sizing: border-box;
        background: #4863d4;
        width: 100%;
      ...
      ">
        ...
        ">
            <div style="background: #f5f5f5; padding: 24px; border-radius: 5px 5px 0px 0px">
                <img
                    src="https://res.cloudinary.com/dwe1p24zb/image/upload/f_auto,q_auto/v1/cashbook/ixdggzto5jld6mlmx0cc" />
                <p style="font-size: 20px">Invitation to join ${business} on CashBook App</p>
            </div>
            <div style="padding: 24px">
                <p>
                    <span>Hi</span>
                    <span style="color: #4863d4"> ${email} , </span>
                </p>
                <p>
                    You have been invited by Robiul Awal to join a business on CashBook App.
                    Open now & access '${business}' here:
    
                    <a href='${url}'' style="color: #4863d4">http://localhost:3000/accept/?email=${email}</a>
                </p>
                <p>
                    If this was not you then please ignore this email so that your account &
